...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["Yêu ba chã cụa anh lúm ó", "Siuuuuu huông ba chã ttuyn un", "Huông ba chã suốt đời un nhóoo"],
      images: [],
      heartColor: "#ff9090",
    },
  };
...
const img = new Image();
img.src =
  "https://raw.githubusercontent.com/Arghhhh1408/my-image/main/images/25e973aa-482d-448e-a22c-ade25f6abcf4.jpg";
